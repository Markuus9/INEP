...
class TxConsultarVideojocCompactat //:  public Transaccio
{
    
public:
    // constructora
    TxConsultarVideojocCompactat(std::string nv, bool mostrarpaq);
    ...
    // Tota aquesta informació es mostra sense fer salts de línia.
